		...
		<div className="fixed top-0 h-24 w-screen z-50 flex justify-center items-center lg:h-16">
			...
			>
				<div className="flex flex-row gap-4 items-center xs:gap-1">
					...
					<button
						className="flex h-full w-16 xs:w-12 items-center justify-center bg-transparent border-none p-4 xs:p-2 cursor-pointer font-bold transition-all duration-100 hover:text-shade-1 focus-visible:text-shade-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-xl"
						type="button"
					...
					>
						{["events", "blog", "team", "documents"].map(link => (
							<a
								...
								className={`flex h-full items-center border-none p-4 cursor-pointer font-bold transition-all duration-100 rounded-xl lg:border hover:text-shade-1 focus-visible:text-shade-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
